...
Graphe* creerGraphe(char* filename) {
    ...
    listesAdjacences = creerListeAdjacences(filename);
    matriceAdjacences = creerMatriceAdjacences(filename);
    
    g->listesAdjacences = listesAdjacences;
    g->matriceAdjacences = matriceAdjacences;
    g->nSommets = nSommets;
    g->oriented = oriented;
    g->valued = valued;
    g->complete = complete;
    
    Sommet* tSommets = creerTableauSommets(*g);
